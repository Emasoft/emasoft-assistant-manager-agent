# Edge Case Protocols for Assistant Manager Agent

This document defines standardized protocols for handling edge cases and failure scenarios in the Assistant Manager Agent (eama-) plugin.
...
The Assistant Manager is the primary communication hub. AI Maestro unavailability severely impacts operations.
...
- [SKILL.md](../SKILL.md) - Core Assistant Manager skill
