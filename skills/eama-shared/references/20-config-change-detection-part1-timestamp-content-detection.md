# Config Change Detection: Timestamp and Content-Based Methods
...
1. [PROCEDURE 1: Timestamp-Based Detection](#procedure-1-timestamp-based-detection)
2. [PROCEDURE 2: Content-Based Detection](#procedure-2-content-based-detection)
